...
const perguntas = [
    {
        enunciado: "Você sabe manusear um aparelho com I.A?",
        alternativas: [
            "Sim",
            "Não"
        ]
    ...
    {
        enunciado: "Acha que ela terá importância no futuro?",
        alternativas: [
            "Sim",
            "Não"
        ]
...
elemento0pcoes.addEventListener("click", () => respostaSelecionada(opcao));
